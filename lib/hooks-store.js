...
async function create(locationId, { name, destinationUrl, customerId, customerName }) {
...
module.exports = { getAll, saveAll, writeTokenIndex, create, update, remove, renameCustomer, detachCustomer, findByCustomer, findByToken, recordIncoming };
